 ...
 */
const componentUpdate = makeComponentUpdate(update)

const componentShallowUpdate = makeComponentUpdate(shallowUpdate)

export default componentUpdate

export { componentShallowUpdate }

function makeComponentUpdate(update) {
  return function componentUpdate(tag, data, expressions) {
    const __ = tag.__
    const nextOpts = {}
